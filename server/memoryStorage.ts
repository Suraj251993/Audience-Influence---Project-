...
export class MemoryStorage implements IStorage {
  ...
  async createCollaboration(collaborationData: InsertCollaboration): Promise<Collaboration> {
    const collaboration: Collaboration = {
      id: this.nextId++,
      campaignId: collaborationData.campaignId,
      influencerId: collaborationData.influencerId,
      status: collaborationData.status || "pending",
      agreedRate: collaborationData.agreedRate || null,
      deliverables: collaborationData.deliverables || null,
      actualReach: collaborationData.actualReach || null,
      actualEngagement: collaborationData.actualEngagement || null,
      completedAt: collaborationData.completedAt || null,
      createdAt: new Date(),
      updatedAt: new Date(),
    };
  ...
  async createAnalytics(analyticsData: InsertAnalytics): Promise<Analytics> {
    const analytics: Analytics = {
      ...
      collaborationId: analyticsData.collaborationId || null,
